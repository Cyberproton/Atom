...
public class EntityStatRemoveModifierEvent extends EntityEvent implements Cancellable {
    private final Stat<?, ?> stat;
    private final Modifier<?> modifier;
    private boolean cancelled;

    public EntityStatRemoveModifierEvent(@NotNull IEntity entity, @NotNull Stat<?, ?> stat, @NotNull Modifier<?> modifier) {
        super(entity);
